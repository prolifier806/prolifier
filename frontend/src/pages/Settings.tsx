...
import { getMediaPrefs, setMediaPrefs, PREFS_EVENT, type MediaPrefs } from "@/lib/mediaCache";
...
export default function Settings() {
  ...
  const toggleAutoDownload = () => setMediaPrefs({ ...mediaPrefs, autoDownloadWifi: !mediaPrefs.autoDownloadWifi });
            ...
            <div className="flex items-center justify-between px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-0.5">Load images automatically as they enter view</p>
                </div>
              </div>
              <button
