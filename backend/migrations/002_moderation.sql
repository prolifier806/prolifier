...
insert into public.blocked_words (word, severity, category) values
  ...
  ('i will kill',         'block', 'threat'),
  ('i kill you',          'block', 'threat'),
  ('gonna kill you',      'block', 'threat'),
  ('going to kill you',   'block', 'threat'),
  ('imma kill you',       'block', 'threat'),
  ('ima kill you',        'block', 'threat'),
  ('kill u',              'block', 'threat'),
  ('i will hurt you',     'block', 'threat'),
  ('i will beat you',     'block', 'threat'),
  ('i will destroy you',  'block', 'threat'),
  ('i want you dead',     'block', 'threat'),
  ('you should die',      'block', 'threat'),
  ('hope you die',        'block', 'threat'),
  ('go die',              'block', 'threat'),
  ('drop dead',           'block', 'threat'),
  ('slit your wrists',    'block', 'threat'),
  ('hang yourself',       'block', 'threat'),
  ('shoot yourself',      'block', 'threat'),
  ('stab you',            'block', 'threat'),
  ('i will stab',         'block', 'threat'),
  ('i will find you',     'block', 'threat'),
  ('i know where you',    'block', 'threat'),
  -- English — violence
  ('rape',               'block', 'threat'),
  ('raping',             'block', 'threat'),
  ('i will rape',        'block', 'threat'),
  ('gonna rape',         'block', 'threat'),
  ('murder you',         'block', 'threat'),
  ('gonna murder',       'block', 'threat'),
  ('i will murder',      'block', 'threat'),
  ('beat you up',        'block', 'threat'),
  ('bash your head',     'block', 'threat'),
  ('cut your throat',    'block', 'threat'),
  ('slice your throat',  'block', 'threat'),
  ('break your legs',    'block', 'threat'),
  ('i will shoot you',   'block', 'threat'),
  ('shoot you',          'block', 'threat'),
  ('shoot u',            'block', 'threat'),
  ('put a bullet',       'block', 'threat'),
  ('molest',             'block', 'threat'),
  ('molesting',          'block', 'threat'),
  -- English — terrorism & extremism
  ('i will bomb',        'block', 'threat'),
  ('gonna bomb',         'block', 'threat'),
  ('bomb threat',        'block', 'threat'),
  ('plant a bomb',       'block', 'threat'),
  ('suicide bomber',     'block', 'threat'),
  ('suicide bomb',       'block', 'threat'),
  ('suicide vest',       'block', 'threat'),
  ('suicide attack',     'block', 'threat'),
  ('mass shooting',      'block', 'threat'),
  ('school shooting',    'block', 'threat'),
  ('terror attack',      'block', 'threat'),
  ('planning a terror',  'block', 'threat'),
  ('planning an attack', 'block', 'threat'),
  ('join isis',          'block', 'threat'),
  ('join isil',          'block', 'threat'),
  ('join daesh',         'block', 'threat'),
  ('support isis',       'block', 'threat'),
  ('long live isis',     'block', 'threat'),
  ('long live isil',     'block', 'threat'),
  ('death to',           'block', 'threat'),
  ('death squad',        'block', 'threat'),
  ('jihad against',      'block', 'threat'),
  ('holy war against',   'block', 'threat'),
  ('boko haram',         'block', 'threat'),
  ('al qaeda',           'block', 'threat'),
  ('al-qaeda',           'block', 'threat'),
  ('isis recruit',       'block', 'threat'),
  ('recruit for isis',   'block', 'threat'),
  -- English — doxxing
